...
object BleService {
    ...
    private val _deviceConnection = MutableLiveData<Int>()
    val deviceConnection = _deviceConnection as LiveData<Int>
    ...
    fun setCurrentChatConnection(device: BluetoothDevice) {
        ...
        _deviceConnection.value = BluetoothProfile.STATE_CONNECTED
    ...
    private class GattServerCallback : BluetoothGattServerCallback() {
        override fun onConnectionStateChange(device: BluetoothDevice, status: Int, newState: Int) {
            ...
            if (isSuccess && isConnected) {
                ...
                _deviceConnection.postValue(BluetoothProfile.STATE_DISCONNECTED)
            }
        }
