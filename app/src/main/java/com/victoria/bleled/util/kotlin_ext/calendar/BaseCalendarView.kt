package com.victoria.bleled.util.kotlin_ext.calendar
...
class BaseCalendarView : FrameLayout {
    ...
    private fun initWeekView() {
        ...
        val layoutParams =
            LayoutParams(LayoutParams.MATCH_PARENT, CommonUtil.dpToPx(context,
                WEEK_VIEW_H
            ))
    ...
    private fun initDayView() {
        ...
        adapter =
            MonthCalendarAdapter(
                context,
                object :
                    MonthCalendarAdapterListener {
        ...
        layoutParams.topMargin = CommonUtil.dpToPx(context!!,
            WEEK_VIEW_H
        )
