...
public class BaseCalendarView extends FrameLayout {
    ...
    private void initWeekView() {
        ...
        LayoutParams layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, CommonUtil.dpToPx(getContext(), WEEK_VIEW_H));
    ...
    private void initDayView() {
        ...
        layoutParams.topMargin = CommonUtil.dpToPx(getContext(), WEEK_VIEW_H);
