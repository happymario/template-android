...
package com.victoria.bleled.service.billing;
...
public class BillingDataSource implements LifecycleObserver, PurchasesUpdatedListener,
    ...
    final private SingleMediatorLiveEvent<Purchase> newPurchaseData = new SingleMediatorLiveEvent<>();
    ...
    public final LiveData<Purchase> observeNewPurchaseData() {
                    ...
                    if (isConsumable) {
                        ...
                        billingClient.acknowledgePurchase(AcknowledgePurchaseParams.newBuilder()
                            ...
                            if (billingResult.getResponseCode()
                                ...
                                newPurchaseData.postValue(purchase);
                            }
                        });
                    } else {
                        newPurchaseData.postValue(purchase);
    ...
    public boolean isBillingSetupCompleted() {
        return billingSetupComplete;
    }
